 ...
 */
extern void FifoInit( Fifo_t *fifo, uint8_t *buffer, uint16_t size );
 ...
 */
extern void FifoPush( Fifo_t *fifo, uint8_t data );
 ...
 */
extern uint8_t FifoPop( Fifo_t *fifo );
 ...
 * \param [IN] fifo   Pointer to the FIFO object
 */
extern void FifoFlush( Fifo_t *fifo );
 ...
 */
extern bool IsFifoEmpty( Fifo_t *fifo );
 ...
 */
extern bool IsFifoFull( Fifo_t *fifo );


extern uint8_t FifoPeek( Fifo_t *fifo );
extern uint16_t GetFifoDataSize( Fifo_t *fifo );
extern void FifoPeekFlush( Fifo_t *fifo );
#endif // __FIFO_H__
